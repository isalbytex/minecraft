...
public final class TrustZakkAgent {
  public static void agentmain(String args, Instrumentation inst) throws Exception {
    ...
    if (serverLoader == null) {
      System.out.println("[TrustZakkAgent] org.bukkit.Bukkit classloader not found");
      return;
    }
    ...
    if (plugin == null) {
      System.out.println("[TrustZakkAgent] MejiClaimsV3 not found");
      return;
    }
    ...
    System.out.println("[TrustZakkAgent] Added Zakk trust entries: " + changed + " across claims: " + claims.size());
  }
}
